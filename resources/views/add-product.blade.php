        ...
        <div class="flex justify-center px-6 my-12">
            ...
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none">
                    <h3 class="pt-4 text-2xl text-center">Add Product</h3>

                    <form method="post" action="{{url('save-product')}}" class="px-8 pt-6 pb-8 mb-4 bg-white rounded" enctype="multipart/form-data">
                        @csrf
